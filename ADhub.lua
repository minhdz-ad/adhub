...
v0.new("<Color=Cyan>Welcome to ADhub<Color=/>"):Display();
wait(0.5);
v0.new("<Color=Yellow>TAOYEUAD<Color=/>"):Display();
wait(1);
repeat
	wait();
...
v5.Window = function(v134, v135)
	...
	v170.Image = "http://www.roblox.com/asset/?id="   .. tostring(0) ;
...
v8.Image = "rbxassetid://77463746448202";
v8.Draggable = true;
...
local v67 = v66:T("Tab Status", "rbxassetid://0");
local v68 = v66:T("Tab General", "rbxassetid://0");
local v69 = v66:T("Tab Setting Other", "rbxassetid://0");
local v70 = v66:T("Tab Item", "rbxassetid://0");
local v71 = v66:T("Tab Race & Mirage", "rbxassetid://0");
local v72 = v66:T("Tab Sea Event", "rbxassetid://0");
local v73 = v66:T("Tab Local Player", "rbxassetid://0");
local v74 = v66:T("Tab Visual", "rbxassetid://0");
local v75 = v66:T("Tab Raid", "rbxassetid://0");
local v76 = v66:T("Tab Teleport", "rbxassetid://0");
...
v74:Button("Rain Fruit", function()
	for v827, v828 in pairs(game:GetObjects("rbxassetid://77463746448202")[1]:GetChildren()) do
...
v74:Button("Kaitun Cap", function(v471)
	...
	for v863, v864 in pairs(v472) do
		if (v495[v864] and (game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy"   .. v864 , true) == 1)) then
			...
			v1663.Image = "rbxassetid://77463746448202";
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "ADhub",
	Text = "Loading...",
	Icon = "http://www.roblox.com/asset/?id=77463746448202",
	Duration = 10
});
spawn(function()
	while wait() do
