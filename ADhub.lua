...
print("ad<3");
local Update = (loadstring(Game:HttpGet("https://raw.githubusercontent.com/minhdz-ad/wew/refs/heads/main/Untitled-1.lua?token=GHSAT0AAAAAADD35KP3YCEOLTBED3Q4UZPS2BHBZJA")))();
...
spawn(function()
	...
	wait(1);
	((require(game.ReplicatedStorage.Notification)).new("<Color=Yellow>[ I LOVE ÁNH DƯƠNG ]<Color=/>")):Display();
end);
function CheckQuest()
...
MainTab:Button("COPY IK HAY CỰC", function()
	setclipboard("vlxx.my");
	Update:Notify("Copied!", 10);
end);
